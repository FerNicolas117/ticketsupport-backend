package com.ticketsupport.api.security.jwt;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    // Constructor
    public JwtAuthenticationFilter(JwtUtil jwtUtil, UserTicketServiceImpl userTicketServiceImpl) {
    ...
    throws ServletException, IOException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = userTicketServiceImpl.loadUserByUsername(username);
